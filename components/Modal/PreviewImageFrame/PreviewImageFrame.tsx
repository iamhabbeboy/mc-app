  ...
  return (
    ...
    <div className="overflow-auto h-screen">
      <div className="mx-auto flex py-10 justify-center item-center pt-10">
        <button onClick={() => { }}><Image src="./logo.svg" width={154} height={34} alt="Logo image" /></button>
      </div>
      <div className="bg-[url('/pattern-2.png')] bg-repeat w-full">
        ...
        <div className={`rounded-[30px] w-[60%] mx-auto py-10 ${style.frame__layout}`}>
          <div className="mx-auto w-[450px]">
            <span className="absolute left-[320px]">
              <Image src="/love-circle.svg" width={159} height={132} alt="love circle image" />
            </span>
            <div className="bg-[url('/frame.png')] w-[450px] h-[562px] bg-contain">
          ...
          <div className="text-center mx-auto mt-5">
            ...
            <button className="button button__create text-white py-2 px-7" onClick={() => { }}><span className="inline">Download Images </span>
            ...
            <div className="mt-5">
              ...
              <p>{""}</p>
              <button className="button button__outline mt-5 py-2 px-7" onClick={() => { }}>Restart </button>
            </div>
          </div>
        </div>
