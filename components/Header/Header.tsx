    ...
    <div className="w-full p-5">
      <div className="container mx-auto flex justify-between">
        ...
        <div className={style.header__layout}>
          ...
          <Link href="https://mcom.ng/shop" target="_blank" className="ml-3 header__linkbutton hidden sm:hidden lg:inline-block md:inline-block"> Visit mcom Shop</Link>
        </div>
      </div>
      <Link href="https://mcom.ng/shop" target="_blank" className="header__linkbutton block mt-5 text-center w-full sm:block lg:hidden md:hidden"> Visit mcom Shop</Link>
    </div>
    </>
  )
}
